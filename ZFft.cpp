...
ZFft::ZFft( int nSamples ) : m_nSamples( nSamples ), m_nLogSamples( IntegerLog2( nSamples ) )
{
...
void ZFft::SetDecay( float fDecay )
{
	m_fDecay = fDecay;
}
...
void ZFft::Update( const short int *anSample )
{
	for (int i = 0; i < m_nSamples; i++)
	{
...
float ZFft::GetAmplitude( int nIdx ) const
{
