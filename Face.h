...
struct Face
{
	...
	// Constructors:
	inline Face() = default;
	inline Face( WORD nVtx1, WORD nVtx2, WORD nVtx3 );
...
Face::Face( WORD nVtx1, WORD nVtx2, WORD nVtx3 )
{
...
void Face::Set( WORD nVtx1, WORD nVtx2, WORD nVtx3 )
{
	m_anVtx[ 0 ] = nVtx1;
	m_anVtx[ 1 ] = nVtx2;
	m_anVtx[ 2 ] = nVtx3;
...
BOOL Face::Contains( WORD nVtx ) const
{
...
void Face::Replace( WORD nOldVtx, WORD nNewVtx )
{
	for( int i = 0; i < 3; i++ )
	{
...
int Face::IndexOf( WORD nVtx ) const
{
	for( int i = 0; i < 3; i++ )
	{
...
WORD &Face::operator[ ]( int nPos )
{
	return m_anVtx[ nPos ];
}

const WORD &Face::operator[ ]( int nPos ) const
{
	return m_anVtx[ nPos ];
}
