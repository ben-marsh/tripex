...
extern void *MoreCore( long nSize );
...
#if __STD_C
#include <H:\Microsoft Xbox SDK\xbox\include\stddef.h>   /* for size_t */
#else
#include <sys/types.h>
#endif
...
#include <H:\Microsoft Xbox SDK\xbox\include\stdio.h>    /* needed for malloc_stats */
#include <H:\Microsoft Xbox SDK\xbox\include\errno.h>    /* needed for optional MALLOC_FAILURE_ACTION */
